...
def show_path() -> None:
    ...
    if config_path.exists():
        ...
        console.print("[yellow]File doesn't exist yet and will be created on first run[/yellow]")
...
def reset_config(force: bool = typer.Option(False, "-f", "--force", help="Skip confirmation")) -> None:
    config_path = get_config_path()
    if not force:
        console.print("[yellow]This will reset your configuration to defaults.[/yellow]")
